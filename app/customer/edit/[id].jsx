...
export default function EditCustomerScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('✅ Updated!', `${name} updated in MongoDB!`);
      router.back();
  ...
  return (
    <View style={{ flex:1, backgroundColor: T.bg }}>
      ...
      <ScrollView contentContainerStyle={{ padding:16, paddingBottom:60 }} showsVerticalScrollIndicator={false}>
        ...
        <FormInput label="Extra Paid Amount (₹)"       value={paidExtra} onChangeText={setPaidExtra} keyboardType="numeric"    theme={T} />
        ...
        <FormInput label='Tiffin Dates (e.g. "10 paid, 11, 12 paid")' value={rawStr} onChangeText={setRawStr} multiline numberOfLines={4} style={{ minHeight:80, textAlignVertical:'top', fontSize:12 }} theme={T} />

        <Text style={{ fontSize:11, color:T.text3, marginBottom:16, lineHeight:17 }}>
          💡 Tip: Dates separated by commas. Write "paid" after a date or group to mark paid.{'\n'}Example: "10 paid, 11, 12, 13 paid, 14"
        </Text>
